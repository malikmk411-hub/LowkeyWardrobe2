      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-20">
          <div className="col-span-1 md:col-span-2">
            <div className="font-serif text-[28px] tracking-[0.18em] mb-4">AURUM</div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li><Link href="/products?category=sale"><span className="text-[13px] text-[#C41E1E] font-light hover:text-[#ff3b3b] transition-colors cursor-pointer">Sale</span></Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li><a href="#" className="text-[13px] text-white/60 font-light hover:text-white transition-colors">About Aurum</a></li>
